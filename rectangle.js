module.exports= (x, y, callback) => {//We will assign a function as a value for the entire export instead of as a method of the export.  When we do that, we have to use module.exports (can't use just exports).
...
//exports.perimeter=(x,y)=> 2*(x+y); //Using exports keyword from Node. We could also write modules.exports instead of just exports.
